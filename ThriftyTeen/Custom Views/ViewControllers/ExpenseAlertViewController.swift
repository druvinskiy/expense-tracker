//
//  ExpenseAlertViewController.swift
//  ThriftyTeen
//
//  Created by David Ruvinskiy on 12/29/23.
//

import UIKit

class ExpenseAlertViewController: UIViewController {
    
    let containerView = AlertContainerView()
    let messageLabel = DRTitleLabel(textAlignment: .center, fontSize: 20, weight: .bold, textColor: .label)
    ...
    init(message: String, handler: @escaping () -> ()) {
